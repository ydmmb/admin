...
import com.universe.yz.admin.model.exception.ExceptionEngine;
import com.universe.yz.admin.model.exception.ServerException;
...
public class HttpMethods {
    ...
    private class ServerResultFunc<T> implements Func1<CommonHttpResponse<T>, T> {
        @Override
        public T call(CommonHttpResponse<T> httpResult) {
